...
export default function KachingButton({ children, href }: KachingButtonProps) {
  const [isPressed, setIsPressed] = useState(false);

  return (
    <div className="bg-blue-200 p-1 rounded w-fit shadow-inner">
      <button
        className={`relative bg-[#0019FF] text-white px-2 sm:px-6 py-3 rounded text-base font-medium overflow-hidden transition-all duration-150 ease-in-out transform-gpu will-change-transform${
