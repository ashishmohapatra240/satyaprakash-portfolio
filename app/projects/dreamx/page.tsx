                                    ...
                                    <div className="space-y-6 lg:max-w-full lg:w-2/3">
                                        ...
                                        <div className="space-y-5">
                                            ...
                                            <ul className="space-y-2 ml-4">
                                                <li className="text-slate-800 text-lg sm:text-xl leading-7">• Foundations: Color & token system</li>
                                                <li className="text-slate-800 text-lg sm:text-xl leading-7">• Identifying & listing components</li>
                                                <li className="text-slate-800 text-lg sm:text-xl leading-7">• Building</li>
                                                <li className="text-slate-800 text-lg sm:text-xl leading-7">• Testing</li>
                                                <li className="text-slate-800 text-lg sm:text-xl leading-7">• Optimisation</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section>
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <h2 className="text-slate-800 text-3xl sm:text-4xl lg:text-5xl font-medium leading-tight">
                                        Structuring the Backbone of<br />Our Design System
                                    </h2>
                                </div>
                                <div className="flex flex-col lg:flex-row gap-12">
                                    <div className="space-y-6 lg:max-w-full lg:w-2/3">
                        ...
                        <section>
                            <div className="space-y-6">
                                ...
                                <div className="flex flex-col lg:flex-row gap-12">
                                    <div className="space-y-6 lg:max-w-full lg:w-2/3">
                                        <p className="text-slate-800 text-lg sm:text-xl leading-relaxed">
                                            We built a robust design system that accelerated the design process by 33%.
