        ...
        <div className="mx-auto">
          ...
          <div className="py-12 sm:py-20 flex flex-col sm:flex-row gap-8 sm:gap-24">
            <div className="text-slate-800 text-xl sm:text-2xl lg:text-3xl leading-relaxed">
              DreamX is an innovative platform that uses advanced AI to
              interpret dreams and provide meaningful insights. The challenge
              was to create an intuitive and engaging interface that makes dream
              interpretation accessible while maintaining a sense of wonder and
              personal connection.
            </div>
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                  <div className="space-y-6 lg:max-w-full lg:w-2/3">
                    <p className="text-slate-800 text-lg sm:text-xl leading-relaxed">
                      After thorough research, I identified several key
                      challenges:
                    </p>
                      ...
                      <div className="flex gap-3">
                        <div className="flex-1 space-y-1">
                          ...
                          <p className="text-slate-800 text-lg sm:text-xl leading-7">
                            Building trust in AI-powered dream interpretation
                            while maintaining the personal nature of dreams
                          </p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        <div className="flex-1 space-y-1">
                          ...
                          <p className="text-slate-800 text-lg sm:text-xl leading-7">
                            Presenting detailed dream interpretations in an
                            easily digestible format
                          </p>
                        </div>
                      </div>
                      <p className="text-slate-800 text-lg sm:text-xl leading-7">
                        The goal was to create a platform that feels both
                        magical and trustworthy, while being easy to use.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <section>
              <div className="space-y-6">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                  <div className="space-y-6 lg:max-w-full lg:w-2/3">
                    <p className="text-slate-800 text-lg sm:text-xl leading-relaxed">
                      I explored various visual directions to create an
                      immersive dream interpretation experience:
                    </p>
                      ...
                      <div className="space-y-2">
                        <p>
                          ...
                          <span className="text-slate-800 text-xl font-normal font-sans">
                            {" "}
                            – Created a dreamy, ethereal interface with subtle
                        ...
                        <p>
                          ...
                          <span className="text-slate-800 text-xl font-normal font-sans">
                            {" "}
                            – Designed a step-by-step process that guides users
            ...
            <section>
              <div className="space-y-6">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                  <div className="space-y-6 lg:max-w-full lg:w-2/3">
                    <p className="text-slate-800 text-lg sm:text-xl leading-relaxed">
                      The final implementation focused on creating a seamless
                      user experience:
                    </p>
                    <p className="text-slate-800 text-lg sm:text-xl leading-relaxed">
                      ...
                      <br />• Interactive elements for deeper exploration
                    </p>
                  </div>
