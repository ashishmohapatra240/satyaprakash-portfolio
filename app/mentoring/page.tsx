...
const Mentoring = () => {
    return (
        <main className="pt-16 pb-0 flex flex-col justify-between">
            {/* Intro Section */}
            <section className="w-full widescreenConstraint min-h-screen flex items-center">
                <div className="flex flex-col items-start justify-center gap-0" style={{ paddingTop: "20vh" }}>
            ...
            <section className="w-full widescreenConstraint pb-16">
            ...
            <section className="w-full widescreenConstraint py-10 space-y-10">
            ...
            {/* Footer Section */}
            <section className="text-center widescreenConstraint py-10 space-y-4">
